...
class EventListCoordinator:Coordinator{
    ...
    func didSelectEvent(eventId:NSManagedObjectID){
        let eventDetailsCoordinator = EventDetailsCoordinator(navigationController: navigationController, eventId: eventId)
